...
public class IniciaSesion implements Serializable {
    ...
    /**
     * Metodo que inicia sesion y te redirecciona a la pagina princpal
    ...
    public String ingresar() {
        ...
        FacesMessage("Error! Contraseña o correo incorrectos",
    ...
    /**
     * Metodo que cierra la sesion de un usuario y te redirecciona
